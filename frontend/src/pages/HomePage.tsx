            ...
            {user ? (
              ...
              <div className="flex items-center gap-2 pl-2 border-l border-border">
                ...
                <button
                  ...
                  className="hidden sm:flex items-center gap-1 rounded-xl border border-dashed border-primary/40 bg-primary/5 px-2.5 py-2 text-xs font-semibold text-primary hover:bg-primary/10 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {demoLoading ? (
          ...
          <div className="rounded-2xl border border-primary/30 bg-primary/5 p-6 text-center shadow-sm">
            ...
            <div className="mt-4 flex items-center justify-center gap-3">
              ...
              <button
                onClick={handleDemoLogin}
                disabled={demoLoading}
                className="flex items-center gap-1.5 rounded-xl border border-border bg-background px-4 py-2 text-xs font-semibold text-foreground hover:bg-muted cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {demoLoading ? (
